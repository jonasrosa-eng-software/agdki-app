...
const TurmaFormEdit = (props: ITurmaFormEditProps) => {
  ...
  const [getStatus] = useState<StatusResponseModel | null>();
  const [optsProf] = useState<ISelectItemProps[]>([]);
  const [optsHor] = useState<ISelectItemProps[]>([]);
  const [optsMod] = useState<ISelectItemProps[]>([]);
